-- BrainRotQuiz Supabase Schema (v1 - Original)
-- =====================================================
-- 이 파일은 마이그레이션 전의 원본 스키마(v1)입니다.
-- 현재 적용된 스키마는 schema.sql (v2)을 참조하세요.
--
-- [변경 이력]
-- v1 (이 파일): 초기 스키마
-- v2 (schema.sql): 테이블 리네이밍 및 구조 개선 (migrations/001_rename_tables.sql 적용)
-- =====================================================
