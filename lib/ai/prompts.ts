...
5. **정답 (correctAnswers) - 매우 중요!**
   - 반드시 배열 형태로 제공
   - 첫 번째가 대표 정답, 이후는 허용되는 대안 정답들

   **단답형/빈칸 (필수로 대안 정답 추가):**
   - 동의어, 유의어 추가 (예: ["인공지능", "AI", "Artificial Intelligence"])
   - 한글/영문 버전 추가 (예: ["대한민국", "한국", "Korea", "South Korea"])
   - 약칭/풀네임 추가 (예: ["UN", "유엔", "국제연합", "United Nations"])
   - 띄어쓰기 변형 추가 (예: ["머신러닝", "머신 러닝", "기계학습", "Machine Learning"])
   - 최소 2-3개 이상의 대안 정답을 포함할 것!

   **객관식:** 정답 보기 1개만 (예: ["정답보기"])
   **OX:** ["O"] 또는 ["X"]
...
**correctAnswers 필수 규칙 (단답형/빈칸):**
- 반드시 동의어, 영문, 약칭 등 2-3개 이상의 대안 정답을 포함하세요
- 예시: ["머신러닝", "ML", "기계학습", "Machine Learning"]
- 사용자가 다양한 표현으로 답해도 정답 처리되도록 해주세요`;
}
